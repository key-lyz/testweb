    ...
    <div class="breadcrumb-wrapper">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8 location"><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a href='index.html'>主页</a> > <a href='yuanxiao.jsp'>院校</a> > <a href='pulinsidun.jsp'>院校详情 </span></div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12 bottom-banner-gate">
                <div class="row">
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4 intro-gate">
                        <img src = "uploads/univ/01 Princeton University.jpg"  class="img-responsive img-intro-gate" alt="">
                    </div>
...
面试（Interview）：申请递交之后，学校便可能邀请申请者参加面试。面试由普林斯顿校友举行，其形式包括电话、视频或面对面等多种形式，因客观条件（如地处偏远，附近无面试资源等）无法参见面试，不会影响录取。另需注意的是，普林斯顿大学不提供校园面试（On-campus Interview）。
    ...
    <script src="/skin/js/bootstrap.min.js">
    </script>
